        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl shadow-2xl p-8">
                <form action="{{ route('register.post') }}" method="POST" class="space-y-5">
                    ...
                    <!-- Username -->
                    <div class="space-y-2">
                        <label for="username" class="text-white text-sm font-medium flex items-center gap-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                            </svg>
                            Username
                    ...
                    <!-- Password -->
                    <div class="space-y-2">
                        <label for="password" class="text-white text-sm font-medium flex items-center gap-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Konfirmasi Password -->
                    <div class="space-y-2">
                        <label for="password_confirmation" class="text-white text-sm font-medium flex items-center gap-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p class="text-center text-gray-300 text-sm">
                    Sudah punya akun?
                    <a href="{{ route('login.index') }}" class="text-indigo-400 hover:text-indigo-300 font-semibold hover:underline transition duration-200">
                        Login di sini
                    </a>
                </p>
            </div>
            ...
            <p class="text-center text-gray-500 text-xs mt-6">
                ...
                <a href="#" class="text-indigo-400 hover:underline">Syarat & Ketentuan</a>
                dan
                <a href="#" class="text-indigo-400 hover:underline">Kebijakan Privasi</a>
            </p>
        </div>
    </div>
</x-layout>
