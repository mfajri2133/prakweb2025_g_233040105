                ...
                <tr class="bg-neutral-primary border-b border-default">
                    ...
                    <td class="px-6 py-4">
                        @if ($post->image)
                            <img src="{{ asset('storage/' . $post->image) }}" alt="{{ $post->title }}"
                                class="w-16 h-10 object-cover rounded-base">
                        @else
                            <img id="preview"
                                class="size-32 rounded-base object-cover border border-default bg-gray-100"
                    ...
                    <td class="px-6 py-4 space-x-2">
                        <a href="{{ route('dashboard.show', $post->slug) }}"
                            class="inline-flex items-center px-3 py-2 bg-brand text-white rounded-base hover:bg-brand-strong text-sm shadow-xs">
                            View
                        </a>

                        <a href="{{ route('dashboard.edit', $post->slug) }}"
                            class="inline-flex items-center px-3 py-2 bg-blue-600 text-white rounded-base hover:bg-blue-700 text-sm shadow-xs">
                            Edit
                        </a>

                        <button onclick="openDeleteModal('{{ $post->id }}', '{{ $post->title }}')"
                            class="inline-flex items-center px-3 py-2 bg-red-600 text-white rounded-base hover:bg-red-700 text-sm shadow-xs">
                            Delete
                        </button>
                    </td>
